    ...
    LoginComponent.prototype.onSubmit = function (form) {
        ...
        this.authService.checkCredentials(this.loginForm.value).subscribe(function (value) {
            if (value != null && value.length > 0) {
                ...
                _this.router.navigateByUrl('/onBoard');
            }
            else {
                console.log("invalid");
...
var OnboardingFormComponent = /** @class */ (function () {
    function OnboardingFormComponent(fb, studentService) {
        var _this = this;
        this.fb = fb;
    ...
    OnboardingFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _shared_student_service__WEBPACK_IMPORTED_MODULE_3__["StudentService"]])
